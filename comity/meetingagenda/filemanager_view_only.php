 ...
 * Modified File manager(View Only)
 *
 * @package   Agenda/Meeting Extension to Committee Module
 * @copyright 2011 Dustin Durand(Modified By)
...
class MoodleQuickForm_Modified_Filemanager extends HTML_QuickForm_element {
    public $_helpbutton = '';
    protected $_options    = array('mainfile'=>'', 'subdirs'=>1, 'maxbytes'=>-1, 'maxfiles'=>-1, 'accepted_types'=>'*', 'return_types'=>FILE_INTERNAL);

    function MoodleQuickForm_Modified_Filemanager($elementName=null, $elementLabel=null, $attributes=null, $options=null) {
        global $CFG, $PAGE;
...
<div id="filemanager-wrapper-{$client_id}" style="display:none">
    ...
    <div class="filemanager-toolbar">
        <input style="visibility:hidden" type="hidden" class="fm-btn-add" id="btnadd-{$client_id}" onclick="return false" value=" {$straddfile}" />
        <input style="visibility:hidden" type="hidden" class="fm-btn-mkdir" id="btncrt-{$client_id}" onclick="return false" value=" $strmakedir" />
...
FMHTML;
    ...
    $module = array(
        ...
        'fullpath'=>'/mod/comity/meetingagenda/filemanager_view_only.js',
